...
var arrayCountries = ['uruguay', 'argentina', 'paraguay', 'perú', 'brasil'];

for (var i = 0; i < arrayCountries.length; i ++) {
  alert(arrayCountries[i]);
}
...
var upperCountry = [];
var lowerCountry = [];
var upperAndLowerCountry = [];

for (var i = 0; i < arrayCountries.length; i ++) {
  upperCountry = arrayCountries[i].substring(0,1).toUpperCase();
  lowerCountry = arrayCountries[i].substring(1, arrayCountries[i].length).toLowerCase();
  upperAndLowerCountry = upperCountry + lowerCountry;
  alert(upperAndLowerCountry);
}
